    ...
    return (
            ...
            <div className="full-form">
              ...
              <div className="divisor2">
                ...
                <button type="submit" className="btnsignin btn btn-outline btn-lg"> log in </button>
              <span />
              <h6> Not registered yet? </h6>
                <button>
                <a href="/sign-up" className="btnsignup btn btn-outline btn-sm" role="button"> sign up
                </a></button>
            </form>
        );
      }
