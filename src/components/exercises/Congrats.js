...
const Congrats = (props) => (<div className="container-fluid p-0 congrats">
        <h1 className="animated fadeIn"> <span role="img" aria-label="celebration">🎉</span></h1>
        <h2 className="animation animated fadeIn delay-2s"> First round completed</h2>
            ...
            <a type="submit" className="btn facebookshare textbutton nonactiv animated fadeIn delay-4s" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Funregelapp.com" target="_blank" rel="noopener noreferrer">Share it on Facebook</a>
